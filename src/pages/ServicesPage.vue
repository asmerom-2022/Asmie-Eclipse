<template>
    <div class="about">
        ...
        <header>
            <h2 class="h2 article-title">Our Services</h2>
        </header>
            ...
            <ul class="service-list">
                ...
                " alt="design icon" width="40" />
                    ...
                    <div class="service-content-box">
                        ...
                        <p class="service-item-text">
                            Modern, professional-grade web design crafted to the highest standards.
                        </p>
                    </div>
                </li>
                ...
                <li class="service-item">
                    ...
                    <div class="service-content-box">
                        ...
                        <p class="service-item-text">
                            High-quality website development with a professional touch.
                        </p>
                    </div>
                </li>
                ...
                <li class="service-item">
                    ...
                    <div class="service-content-box">
                        ...
                        <p class="service-item-text">
                            Expert development of mobile applications for iOS and Android.
                        </p>
                    </div>
